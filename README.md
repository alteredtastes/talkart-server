...
"CREATE" - "BACKGROUND" - "COLOR" - [Prompt shows to capture name of a color or of something colorful, ex. "sky" or "grass"] - "GO" - Runs Colr.org call for hex values related to word.  
